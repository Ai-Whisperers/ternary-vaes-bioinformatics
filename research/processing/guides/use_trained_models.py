...
Usage:
    python src/scripts/research/use_trained_models.py --application hiv_resistance
    python src/scripts/research/use_trained_models.py --application escape_prediction
    python src/scripts/research/use_trained_models.py --application transfer_learning
    python src/scripts/research/use_trained_models.py --all
"""
...
# Add project root (research/processing/guides -> root)
try:
...
def demo_hiv_resistance_prediction():
    ...
    checkpoint_path = PROJECT_ROOT / "checkpoints/multitask_disease/best.pt"
    ...
    if checkpoint_path.exists():
        ...
        print("Run: python src/scripts/training/train_multitask_disease.py --diseases hiv")
...
def demo_structure_conditioned():
    ...
    print("  python src/scripts/training/train_diffusion_codon.py --disease hiv --structure-conditioned")
...
def main():
  ...
  1. Train with real data:
     python src/scripts/training/train_multitask_disease.py --diseases hiv cancer ra --use-escape-head --evaluate

  2. Run meta-learning for variant adaptation:
     python src/scripts/training/train_meta_learning.py --disease hiv --use-escape-head --evaluate

  3. Generate optimized sequences:
     python src/scripts/training/train_diffusion_codon.py --disease hiv --use-codon-loss --evaluate
