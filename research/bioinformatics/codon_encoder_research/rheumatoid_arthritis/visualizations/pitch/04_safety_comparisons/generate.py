...
def create_safety_comparison():
    ...
    bars2 = ax2.bar(
        x,
        mean_margins,
        color=[colors[i] for i in range(len(proteins))],
        edgecolor="white",
        linewidth=2,
    )
...
def create_safety_summary():
    ...
    ax.text(
        5,
        5.5,
        "Regenerative Therapy Safety Profile",
        fontsize=20,
        fontweight="bold",
        ha="center",
        color=PALETTE["text"],
    ...
    ax.text(
        5,
        0.35,
        "✓ PRG4 and Collagen II recommended for cell therapy applications",
        fontsize=11,
        ha="center",
        va="center",
        color=PALETTE["safe"],
