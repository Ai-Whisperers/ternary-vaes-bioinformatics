...
def create_intervention_diagram():
    ...
    ax.text(
        8,
        9.5,
        "Three-Tier Regenerative Protocol",
        fontsize=24,
        fontweight="bold",
        ha="center",
        color=PALETTE["text"],
    ...
    ax.text(
        8,
        8.9,
        "Sequential Intervention Based on P-adic Pathway Geometry",
        fontsize=13,
        ha="center",
    ...
    ax.text(
        ...
        bbox=dict(
            boxstyle="round",
            facecolor="white",
            edgecolor=PALETTE["inflammation"],
            alpha=0.8,
        ),
    )
    ...
    ax.text(
        ...
        bbox=dict(
            boxstyle="round",
            facecolor="white",
            edgecolor=PALETTE["regeneration"],
            alpha=0.8,
        ),
    )
...
def create_pathway_distances_chart():
    ...
    bars1 = ax.bar(
        ...
        regen_dist,
        width,
        label="Distance to Regeneration",
        color=PALETTE["regeneration"],
        edgecolor="white",
        linewidth=1.5,
    )
    bars2 = ax.bar(
        ...
        inflam_dist,
        width,
        label="Distance to Inflammation",
        color=PALETTE["inflammation"],
        edgecolor="white",
        linewidth=1.5,
    )
