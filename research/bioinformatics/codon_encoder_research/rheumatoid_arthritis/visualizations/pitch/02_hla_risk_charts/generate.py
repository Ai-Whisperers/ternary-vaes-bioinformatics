...
def create_risk_chart():
    ...
    sizes = [
        ...
        category_counts["moderate"],
        category_counts["neutral"],
        category_counts["protective"],
    ]
    colors_pie = [
        HLA_RISK_COLORS["high"],
        HLA_RISK_COLORS["moderate"],
        HLA_RISK_COLORS["neutral"],
        HLA_RISK_COLORS["protective"],
    ]
