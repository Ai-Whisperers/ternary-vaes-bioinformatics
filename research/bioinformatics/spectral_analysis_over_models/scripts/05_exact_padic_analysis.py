...
def main():
    ...
    ax2.axvline(
        func_eq_results["best_reflection_point"] / 2,
        color="r",
        linestyle="--",
        label=f'β*/2 = {func_eq_results["best_reflection_point"]/2:.2f}',
    )
    ax2.set_xlabel("β")
    ...
    theoretical[9] = 1
    ax4.scatter(
        list(theoretical.keys()),
        list(theoretical.values()),
        color="red",
        marker="x",
        s=100,
        label="Theoretical",
