...
python src/scripts/af3_pipeline.py discover

# Check job status
python src/scripts/af3_pipeline.py status

# Export batches for AlphaFold Server (20 jobs/day limit)
python src/scripts/af3_pipeline.py export --disease rheumatoid_arthritis

# Import results from downloaded ZIP
python src/scripts/af3_pipeline.py import --zip results.zip --disease rheumatoid_arthritis

# Generate validation report
python src/scripts/af3_pipeline.py report
```
...
python src/scripts/analyze_predictions.py --disease rheumatoid_arthritis --json
```
...
```bash
python src/scripts/ddg_benchmark.py
```
