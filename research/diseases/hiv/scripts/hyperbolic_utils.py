...
def load_codon_encoder(device: str = "cpu", version: str = "3adic") -> Tuple[CodonEncoder, dict, bool]:
    ...
    # New path structure: research/diseases/hiv/scripts
    # parents: [0]=hiv, [1]=diseases, [2]=research, [3]=project_root
    project_root = script_dir.parents[3]  # Navigate to ternary-vaes root
