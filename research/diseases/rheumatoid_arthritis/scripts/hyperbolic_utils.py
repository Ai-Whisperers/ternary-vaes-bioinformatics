...
def load_codon_encoder(device: str = "cpu", version: str = "3adic") -> Tuple[CodonEncoder, dict, bool]:
    ...
    # New structure: research/diseases/rheumatoid_arthritis/scripts/
    # parents: [0]=scripts, [1]=rheumatoid_arthritis, [2]=diseases, [3]=research, [4]=root
    project_root = script_dir.parents[4]  # Navigate to ternary-vaes root
...
def encode_codon_hyperbolic(codon: str, encoder: HyperbolicCodonEncoder) -> np.ndarray:
    """
