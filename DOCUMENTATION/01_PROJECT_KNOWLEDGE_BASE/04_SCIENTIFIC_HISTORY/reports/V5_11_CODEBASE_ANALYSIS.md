...
<!-- embed: DOCUMENTATION/06_DIAGRAMS/01_ARCHITECTURE/legacy_v5_11_architecture_split.mmd -->
```mermaid
...
### Chain 4: **init**.py exports EVERYTHING
...
### Chain 5: Top-Level src/**init**.py Pulls Legacy Trainers
...
### 5.1 Model Aliases (src/models/**init**.py)
...
### 5.2 Loss Exports (src/losses/**init**.py)
...
### 5.3 Training Exports (src/training/**init**.py)
...
| 2025-12-19 | 0.3     | Added duplicated functionality analysis, accurate line counts from wc -l, Chain 5 (src/**init**.py), outdated src/README.md finding                                                                                                                                               |
