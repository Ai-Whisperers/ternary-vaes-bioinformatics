...
Usage:
    python scripts/experiments/epsilon_vae/sweep_strategic.py
"""
...
def run_experiment(config, all_ops, indices, device, base_ckpt_path):
    ...
    save_dir = PROJECT_ROOT / f"sandbox-training/checkpoints/sweep_{exp_name}"
...
def main():
    ...
    # Save summary
    summary_path = PROJECT_ROOT / "sandbox-training/checkpoints/sweep_summary.json"
