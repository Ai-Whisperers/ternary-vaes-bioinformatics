...
Usage:
    python scripts/experiments/epsilon_vae/stability_verification.py
"""
...
def run_single_experiment(run_id, all_ops, indices, device, base_ckpt_path,
    ...
    save_dir = PROJECT_ROOT / f"sandbox-training/checkpoints/stability_run_{run_id}"
...
def main():
    ...
    summary_path = PROJECT_ROOT / "sandbox-training/checkpoints/stability_summary.json"
