...
class ExperimentRunner:
    ...
    def run_enhanced_training(self) -> Dict[str, Any]:
        ...
        for drug in self.config.nrti_drugs[:3]:  # Start with subset
            ...
            result = self.run_script(
                "scripts/experiments/run_enhanced_training.py",
                args=[
                    "--drug",
                    drug,
                    "--drug-class",
    ...
    def run_maml_evaluation(self) -> Dict[str, Any]:
        ...
        for drug in held_out_pi:
            ...
            result = self.run_script(
                "scripts/experiments/run_maml_evaluation.py",
                args=[
                    "--eval-drug",
                    drug,
                    "--drug-class",
    ...
    def run_multitask_training(self) -> Dict[str, Any]:
        ...
        result = self.run_script(
            "scripts/experiments/run_multitask_training.py",
            args=[
                "--drug-class",
                "PI",
                "--epochs",
    ...
    def run_external_validation(self) -> Dict[str, Any]:
        ...
        result = self.run_script(
            "scripts/experiments/run_external_validation.py",
            args=[
                "--drugs",
                *test_drugs,
                "--results-dir",
