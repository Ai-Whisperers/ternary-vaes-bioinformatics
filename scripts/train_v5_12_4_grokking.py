...
Usage:
    python scripts/train_v5_12_4_grokking.py
    python scripts/train_v5_12_4_grokking.py --config configs/v5_12_4_extended_grokking.yaml
    python scripts/train_v5_12_4_grokking.py --epochs 500 --device cuda
...
def main():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="configs/v5_12_4_extended_grokking.yaml",
