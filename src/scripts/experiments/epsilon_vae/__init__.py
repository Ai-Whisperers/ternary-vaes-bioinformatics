...
Usage:
    python src/scripts/epsilon_vae/train_epsilon_vae.py --config src/configs/epsilon.yaml
    python src/scripts/epsilon_vae/analyze_run.py --run outputs/runs/latest
"""
