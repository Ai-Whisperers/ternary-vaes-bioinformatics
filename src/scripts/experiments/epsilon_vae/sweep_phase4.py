...
Usage:
    python scripts/experiments/epsilon_vae/sweep_phase4.py
"""
...
def run_experiment(config, all_ops, indices, device, base_ckpt_path):
    ...
    save_dir = PROJECT_ROOT / f"sandbox-training/checkpoints/sweep4_{exp_name}"
...
def main():
    ...
    summary_path = PROJECT_ROOT / "sandbox-training/checkpoints/sweep4_summary.json"
