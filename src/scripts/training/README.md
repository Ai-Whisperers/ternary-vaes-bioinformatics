...
Edit `src/configs/v5_11_11_homeostatic_ale_device.yaml` for:
...
python src/scripts/training/train_v5_11_11_homeostatic.py --batch_size 256

# Resume from checkpoint
python src/scripts/training/train_v5_11_11_homeostatic.py --resume

# Skip v5.5 pre-training (random initialization)
python src/scripts/training/train_v5_11_11_homeostatic.py --skip_v5_5
```
